export const PaymentAcceptorABI = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "whitelistAddr", type: "address" },
      { internalType: "uint256", name: "paymentAmount", type: "uint256" },
    ],
    name: "__PaymentAcceptor_init",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "address", name: "kmcTokenAddress_", type: "address" },
    ],
    name: "__WalletUpgradeable_init",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IWhitelistCounterV1",
        name: "",
        type: "address",
      },
    ],
